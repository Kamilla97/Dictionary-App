...
//TODO: implement search bar with audio
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center px-6 py-4 bg-seasalt shadow-lg">
      ...
      >
        <Link to="/">
          <li className="font-semibold text-black py-2 md:py-0 transform hover:scale-105 hover:text-mikado_yellow transition-all duration-200">
            Home
          </li>
        </Link>
        <Link to="/about">
        ...
        {!auth.role && (
          <>
            ...
            <Link to="/login">
              <li className="font-semibold text-black py-2 md:py-0 transform hover:scale-105 hover:text-risd_blue transition-all duration-200">
                Login
              </li>
            </Link>
          </>
        ...
        {auth.role && (
          <li
            className="font-semibold text-black py-2 md:py-0 transform hover:scale-105 hover:text-red-500 transition-all duration-200 cursor-pointer"
